...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/divil-123/VEMPIRE-MD/commits/main");
        ...
        await reply("🚀 Updating 𝗩𝗘𝗠𝗣𝗜𝗥𝗘_𝗠𝗗 Bot...");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/divil-123/VEMPIRE-MD/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "/Vempire-MD-main");
