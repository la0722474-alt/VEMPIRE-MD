...
cmd({
  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(config.MENU_IMAGE_URL || "https://files.catbox.moe/yr0xau.jpg", {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "VEMPIRE-MD 🥀",
            body: config.DESCRIPTION || "𝗩𝗘𝗠𝗣𝗜𝗥𝗘_𝗠𝗗 🤌💗",
            mediaType: 1,
